...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:pb-24">
      <div className="w-full max-w-sm">
        {/* Title */}
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-white">Welcome Back</h1>
          <p className="text-gray-400 mt-1 sm:mt-2 text-sm sm:text-base">Sign in to your KabirClub account</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 sm:p-6 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-3 h-3 sm:w-4 sm:h-4 text-[#daa520] bg-gray-800 border-gray-700 rounded focus:ring-[#daa520] focus:ring-2"
                />
                <span className="ml-2 text-xs sm:text-sm text-gray-300">Remember me</span>
              </label>
              <Link
                href="/forgot-password"
                className="text-xs sm:text-sm text-[#daa520] hover:text-[#b38a1d] transition-colors duration-200"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="space-y-2 sm:space-y-3">
            <button className="w-full py-2 sm:py-3 px-3 sm:px-4 bg-gray-800 border border-gray-700 rounded-lg text-white hover:bg-gray-700 transition-colors duration-200 flex items-center justify-center gap-2 sm:gap-3">
              ...
              <span className="text-xs sm:text-sm md:text-base">Continue with Google</span>
            </button>
            ...
            <button className="w-full py-2 sm:py-3 px-3 sm:px-4 bg-gray-800 border border-gray-700 rounded-lg text-white hover:bg-gray-700 transition-colors duration-200 flex items-center justify-center gap-2 sm:gap-3">
              ...
              <span className="text-xs sm:text-sm md:text-base">Continue with Facebook</span>
            </button>
          </div>
