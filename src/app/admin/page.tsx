  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="mt-2 font-display text-h2 text-paper">Welcome back, {user?.name}!</h1>
      ...
      <div className={STAT_GRID}>
        <div className={STAT_TILE}>
          ...
          <p className={STAT_VALUE}>{stats.loading ? '...' : stats.totalProducts}</p>
        </div>
        ...
        <div className={STAT_TILE}>
          ...
          <p className={STAT_VALUE}>{stats.loading ? '...' : stats.totalCollections}</p>
        </div>
      ...
      <div>
        ...
        <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          <a href="/admin/products/new" className={ACTION_TILE}>
            <svg
              aria-hidden="true"
              className="h-5 w-5 flex-shrink-0 text-zari-500"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
